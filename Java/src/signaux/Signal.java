...
public final class Signal implements Comparable<Signal> {
    ...
    public void setNumEmetteurRecpteurSignal() {
        try {
            if (this.getOrientationSignal().equals("N") || this.getOrientationSignal().equals("SAT") || this.getOrientationSignal().equals("SAD")) {
            ...
            if (this.getOrientationSignal().equals("A") || this.getOrientationSignal().equals("SAT")) {
                if (this.getDirectionSignal() < 0) {
     ...
     * @return
     */
    public boolean rejeteSignal1(Position positionEmRec) {
        try {
            ...
            switch (signal) {
                case "SAT+":
                    resultat = !(positionEmRec.getLigne() == 0 || positionEmRec.getColonne() == 9);
                    break;
                case "SAT-":
                    resultat = !(positionEmRec.getLigne() == 9 || positionEmRec.getColonne() == 0);
                    break;
                case "A+":
                    resultat = !(positionEmRec.getLigne() == 0);
                    break;
                case "A-":
                    resultat = !(positionEmRec.getLigne() == 9);
                    break;
                case "N+":
                    resultat = !(positionEmRec.getColonne() == 9);
                    break;
                case "N-":
                    resultat = !(positionEmRec.getColonne() == 0);
                    break;
                case "SAD+":
                    resultat = !(positionEmRec.getLigne() == 9 || positionEmRec.getColonne() == 9);
                    break;
                case "SAD-":
                    resultat = !(positionEmRec.getLigne() == 0 || positionEmRec.getColonne() == 0);
                    break;
                default:
                    resultat = true;
                    break;
