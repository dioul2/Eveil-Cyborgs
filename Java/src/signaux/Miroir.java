...
public final class Miroir {
    ...
    public void setOrientationMiroir() {
        try {
            this.numeroMiroir -= 1;
            if (this.numeroMiroir < 0) {
                this.numeroMiroir += 8;
            }

            switch (this.numeroMiroir) {
                case 0:
                    this.orientationMiroir = "N";
                    break;
                case 1:
                    this.orientationMiroir = "SATN";
                    break;
                case 2:
                    this.orientationMiroir = "SAT";
                    break;
                case 3:
                    this.orientationMiroir = "SATA";
                    break;
                case 4:
                    this.orientationMiroir = "A";
                    break;
                case 5:
                    this.orientationMiroir = "SADA";
                    break;
                case 6:
                    this.orientationMiroir = "SAD";
                    break;
                case 7:
                    this.orientationMiroir = "SADN";
                    break;
                default:
                    break;
            }
     ...
     */
    public Boolean getEffetRaisonnance() {
        return this.effetRaisonnance;
    }

    public void setEffetRaisonnance(Boolean effetRaisonnance) {
        this.effetRaisonnance = effetRaisonnance;
    }
